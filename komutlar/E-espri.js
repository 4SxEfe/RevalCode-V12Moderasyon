...
exports.run = (client, message) => {
  message.channel.send("Espri Aranıyor....").then(message => {
    var espriler = [
      "  Seni görünce; \ngözlerim dolar, \nkulaklarım euro.",
      ...
      "  Bacaktaki 10'a ne denir ,Pantalon",
      "  Örümcek adam ağ atamıyormuş neden ? ,Ağ bağlantısı kopmuş",
      "  +Baykuşlar vedalaşırken ne der? \n-Bay bay baykuş.",
      "  Bozuk paran varmı ,yok hepsini tamir ettim",
      ...
      "  eli olmayan adama ne denir ,no-el baba",
